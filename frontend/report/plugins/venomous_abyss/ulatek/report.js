(function () {
  ...
  function renderCritical() {
    const data = boss().critical || {}, malice = data.malice || {}, melee = data.nonTankMelee || {}, wrath = data.motherWrath || {}, focus = data.platform2To3;
