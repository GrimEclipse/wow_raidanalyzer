...
- A full-report JSON opens on a WCL-style Pull overview with result, duration,
  wipe summary, and phase timeline. Selecting a Pull enters its skill analysis;
  the header always retains Home and full-report overview navigation.
