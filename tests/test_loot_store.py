...
class LootStoreTests(unittest.TestCase):
    ...
    def test_blackmark_verdict_defaults_and_invalid_fallback(self):
        ...
        default_mark = loot_store.add_blackmark({"date": "2026-08-15", "difficulty": "heroic", "playerId": "tank"})["mark"]
        self.assertEqual(default_mark["verdict"], "black")
        invalid = loot_store.add_blackmark({"date": "2026-08-16", "difficulty": "heroic", "playerId": "tank", "verdict": "purple"})["mark"]
