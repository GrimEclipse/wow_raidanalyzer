...
MODE_DRAFTS["sszorak"] = {
    ...
    "majorMechanics": [
        ...
        },
        {
            ...
            "note": "史诗毒蛇之怒：14 人进入 8 码清怒，否则无拘狂暴",
        },
    ],
}
...
MODE_DRAFTS["twinfangs"] = {
    ...
    "summary": (
        ...
        "随后用涌动射线转移；史诗额外加入液滴护盾、场边蛇群打断和污染之血。"
    ),
...
PHASE_DRAFTS["sszorak"] = [
    ...
    (
        ...
        "至少 14 人进入点名玩家 8 码内触发 To the Slaughter 清怒；100 怒获得无拘狂暴。",
    ),
]
...
PHASE_DRAFTS["twinfangs"] = [
    ...
    (
        ...
        "打断液滴护盾的受护孵化，分组持续打断场边 Broodling 的内脏爆裂，并处理盛宴后的污染之血。",
    ),
    (
        "中场狂暴",
        "第三次涌动转场结束",
